...
<%!	String application_no,cus_name,cus_email,cus_address,cus_adhar,chassis_no,engine_no,ownership,v_type,v_class,fuel,
	...
	result=TempBL.addTempoRequest(temp);
		if(result>0)
		{
			%>
			<script type="text/javascript">
			 alert('Temporary Request Submitted!!! ');
		...
		else
		{
			...
			<script type="text/javascript">
			 ...
			 window.location="temporary_request_form.jsp";
			 </script>
			 <%
		}
	...
	{
		System.out.println("**Error**: Temporary:temp_request_process.jsp:"+e.getMessage());
		%>
		<script type="text/javascript">
		 alert('Error occurs Please Try again!!! ');
		 window.location="temporary_request_form.jsp";
