...
<% count_tp_alloted=TempDL.getCountTPAlloted(); %>
  <!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="font-size:15px;background-color:grey">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="dealer_view_id.jsp">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger notification" href="view_tp_alloted.jsp">TP Notification
            <span class="badge"><%=count_tp_alloted%></span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="temporary_request_form.jsp">TP Request</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="view_all_temprequest.jsp">View TP Request</a>
          </li>
         <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="../Authentication/logout.jsp">Logout</a>
          </li>
        </ul>
  ...
  <!-- Services -->
  <section class="page-section" id="services" style="font-size:13px;">
    <div class="container">
      <div class="row">
          ...
          <ul class="timeline">
            <li>
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="../img/bg-img/about4.jpg" alt="">
              </div>
            ...
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="../img/bg-img/about2.jpg" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>March 2011</h4>
            ...
            <li>
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="../img/bg-img/about3.jpg" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>December 2017</h4>
            ...
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="../img/bg-img/about5.png" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>November 2019</h4>
