...
public class TempDTO 
{
	...
	color,company_name;
	String puchase_date,expiry_date,permanent_no,temp_no,tp_allot_date;
	long cus_phone;
	int seating,status,count;
	double sale_amount;
	...
	public String getCus_adhar()
	{
		return cus_adhar;
	}
	public void setCus_adhar(String cus_adhar) 
	{
		this.cus_adhar = cus_adhar;
	}
